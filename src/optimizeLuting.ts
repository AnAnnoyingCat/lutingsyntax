 ...
 */
export function optimizeYourLuting(input: string, maxItr: number, optimization: string): string{
...
/**
     ...
     */
function optimizeMacros(tokens: lutingToken[], maxItr: number, safe: boolean, quick: boolean): string{
 ...
 */
function provideLutingTokensFromString(inputText: string): lutingToken[] {
 ...
 */
function removeComments(tokens: lutingToken[]): lutingToken[]{
 ...
 */
function tokensToString(tokens: lutingToken[]): string{
	let returnString = "";
 ...
 */
function equalTokens(t1s: lutingToken[], t2s: lutingToken[]): boolean{
 ...
 */
function expandDefinitions(tokens: lutingToken[]): string{
	let res: string = "";
